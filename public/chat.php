            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
							<div class="tab-content" id="nav-tabContent">
								<div class="tab-pane fade show active" id="list-user1" role="tabpanel" aria-labelledby="list-user-1">
									<h4 class="card-title">User 1<br></h4>
									<div class="container chat chat-user1" style="overflow-y: scroll; height: 550px;">
										<div class="row">
											<div class="timeline-centered">
															...
															<div id="sample-checkin" class="map-checkin" style="height: 170px; width: 100%; position: relative; background-color: rgb(229, 227, 223); overflow: hidden; -webkit-transform: translateZ(0);">
																<div class="gm-style" style="position: absolute; left: 0px; top: 0px; overflow: hidden; width: 100%; height: 100%; z-index: 0;">
																	...
																	<div class="gmnoprint" style="z-index: 1000001; position: absolute; right: 192px; bottom: 0px; width: 85px;">
																		<div draggable="false" class="gm-style-cc" style="-webkit-user-select: none;">
																			...
																			<div style="position: relative; padding-right: 6px; padding-left: 6px; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(68, 68, 68); white-space: nowrap; direction: ltr; text-align: right;">
																				<a style="color: rgb(68, 68, 68); text-decoration: none; cursor: pointer;">Dados do mapa</a>
																	...
																	<div class="gmnoprint gm-style-cc" draggable="false" style="z-index: 1000001; position: absolute; -webkit-user-select: none; right: 113px; bottom: 0px;">
																		...
																		<div style="position: relative; padding-right: 6px; padding-left: 6px; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(68, 68, 68); white-space: nowrap; direction: ltr; text-align: right;">
																			<a href="http://www.google.com/intl/pt-BR_US/help/terms_maps.html" target="_blank" style="text-decoration: none; cursor: pointer; color: rgb(68, 68, 68);">Termos de Uso</a>
																		</div>
																	</div>
																	...
																	<div class="gmnoprint" style="margin: 5px; z-index: 0; position: absolute; cursor: pointer; right: 0px; top: 0px;">
																		<div class="gm-style-mtc" style="float: left;">
																			...
																			<div style="background-color: white; z-index: -1; padding-top: 2px; -webkit-background-clip: padding-box; background-clip: padding-box; border-width: 0px 1px 1px; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-right-color: rgba(0, 0, 0, 0.14902); border-bottom-color: rgba(0, 0, 0, 0.14902); border-left-color: rgba(0, 0, 0, 0.14902); -webkit-box-shadow: rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px; box-shadow: rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px; position: absolute; left: 0px; top: 19px; text-align: left; display: none;">
																				<div draggable="false" title="Mostrar mapa de ruas com terreno" style="color: rgb(0, 0, 0); font-family: Roboto, Arial, sans-serif; -webkit-user-select: none; font-size: 11px; background-color: rgb(255, 255, 255); padding: 3px 8px 3px 5px; direction: ltr; text-align: left; white-space: nowrap;">
																					...
																					<label style="vertical-align: middle; cursor: pointer;">Terreno</label>
																				</div>
																			</div>
																		</div>
																		<div class="gm-style-mtc" style="float: left;">
																			...
																			<div style="background-color: white; z-index: -1; padding-top: 2px; -webkit-background-clip: padding-box; background-clip: padding-box; border-width: 0px 1px 1px; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-right-color: rgba(0, 0, 0, 0.14902); border-bottom-color: rgba(0, 0, 0, 0.14902); border-left-color: rgba(0, 0, 0, 0.14902); -webkit-box-shadow: rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px; box-shadow: rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px; position: absolute; right: 0px; top: 19px; text-align: left; display: none;">
																				<div draggable="false" title="Aumentar o zoom para a visualização de 45 graus" style="color: rgb(184, 184, 184); font-family: Roboto, Arial, sans-serif; -webkit-user-select: none; font-size: 11px; background-color: rgb(255, 255, 255); padding: 3px 8px 3px 5px; direction: ltr; text-align: left; white-space: nowrap; display: none;">
																				...
																				<div draggable="false" title="Mostrar imagens com nomes de rua" style="color: rgb(0, 0, 0); font-family: Roboto, Arial, sans-serif; -webkit-user-select: none; font-size: 11px; background-color: rgb(255, 255, 255); padding: 3px 8px 3px 5px; direction: ltr; text-align: left; white-space: nowrap;">
																					<span role="checkbox" style="box-sizing: border-box; position: relative; line-height: 0; font-size: 0px; margin: 0px 5px 0px 0px; display: inline-block; background-color: rgb(255, 255, 255); border: 1px solid rgb(198, 198, 198); border-top-left-radius: 1px; border-top-right-radius: 1px; border-bottom-right-radius: 1px; border-bottom-left-radius: 1px; width: 13px; height: 13px; vertical-align: middle;">
																						<div style="position: absolute; left: 1px; top: -2px; width: 13px; height: 11px; overflow: hidden;">
																							<img src="http://maps.gstatic.com/mapfiles/mv/imgs8.png" draggable="false" style="position: absolute; left: -52px; top: -44px; -webkit-user-select: none; border: 0px; padding: 0px; margin: 0px; width: 68px; height: 67px;">
																						</div>
																					</span>
																					<label style="vertical-align: middle; cursor: pointer;">Marcadores</label>
																				</div>
																			</div>
																		</div>
																	</div>
												...
												<article class="timeline-entry left-aligned">
													<div class="timeline-entry-inner">
														...
														<div class="timeline-label">
															<h2>
																<a href="#">Arber Nushi</a>
																<span>changed his</span>
												...
												<article class="timeline-entry begin">
													<div class="timeline-entry-inner">
														...
														<div class="timeline-label">
																<textarea id="message-1" rows="4" cols="38" style="resize: none;">
																</textarea>
															<button id="send-1" class="btn btn-outline-success">Send <i class="fa fa-paper-plane"></i></button>
														</div>
													</div>
												</article>
											</div>
								...
								<div class="tab-pane fade" id="list-user2" role="tabpanel" aria-labelledby="list-user-1">
								<h4 class="card-title">User 2<br></h4>
									<div class="container chat chat-user2" style="overflow-y: scroll; height: 550px;">
										<div class="row">
											<div class="timeline-centered">
												<article class="timeline-entry">
													<div class="timeline-entry-inner">
												...
												<article class="timeline-entry begin">
													<div class="timeline-entry-inner">
														...
														<div class="timeline-label">
																<textarea id="message-2" rows="4" cols="38" style="resize: none;">
																</textarea>
															<button id="send-2" class="btn btn-outline-success">Send <i class="fa fa-paper-plane"></i></button>
														</div>
													</div>
												</article>
											</div>
								...
								<div class="tab-pane fade" id="list-user3" role="tabpanel" aria-labelledby="list-user-1">
									<h4 class="card-title">User 3<br></h4>
									<div class="container chat chat-user3" style="overflow-y: scroll; height: 550px;">
										<div class="row">
											<div class="timeline-centered">
												<article class="timeline-entry">
													<div class="timeline-entry-inner">
												...
												<article class="timeline-entry begin begin-3">
													<div class="timeline-entry-inner">
														<div class="timeline-icon" style="-webkit-transform: rotate(-90deg); -moz-transform: rotate(-90deg);">
															<i class="entypo-flight"></i>
														</div>
														<div class="timeline-label">
																<textarea id="message-3" rows="4" cols="38" style="resize: none;">
																</textarea>
															<button id="send-3" class="btn btn-outline-success">Send <i class="fa fa-paper-plane"></i></button>
														</div>
													</div>
												</article>
											</div>
                ...
                <div class="col-md-3 col-lg-3">
					<div class="list-group" id="list-tab" role="tablist">
						<a class="list-group-item list-group-item-action active" id="list-user-1" data-toggle="list" href="#list-user1" role="tab" aria-controls="user1">User 1</a>
						<a class="list-group-item list-group-item-action" id="list-user-2" data-toggle="list" href="#list-user2" role="tab" aria-controls="user2">User 2</a>
						<a class="list-group-item list-group-item-action" id="list-user-3" data-toggle="list" href="#list-user3" role="tab" aria-controls="user3">User 3</a>
					</div>
                </div>
            </div>
        </div>

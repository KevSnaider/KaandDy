        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-9">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">User1<br></h4>
                            <div class="container">
                                <div class="row">
                ...
                <div class="col-md-6 col-lg-3 offset-lg-0">
                    <ul class="list-group">
                        <li class="list-group-item active"><span>User 1</span></li>
                        <li class="list-group-item"><span>User 2</span></li>
                        <li class="list-group-item"><span>User 3</span></li>
                    </ul>
                </div>
            </div>
        </div>
